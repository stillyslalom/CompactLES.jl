...
The `147 testsets` and the `220/220` are counted by different mechanisms and are
...
the device/adapt testsets); the `147` counts those rows. A failure is
